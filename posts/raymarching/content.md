...
Ray marching follows the same concept as ray tracing (following rays through space), but lowers the computational load through some computational cleverness.
